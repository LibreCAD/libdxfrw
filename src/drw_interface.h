...
public:
   ...
   */
  // Added after the original interface contract; keep old concrete
  // DRW_Interface implementations source-compatible with a no-op default.
  virtual void addDimArc(const DRW_DimArc *data) { DRW_UNUSED(data); }
