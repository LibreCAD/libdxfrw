...
- Active work: I0.2b exact parser-publication/callback proof, with its raw
  ...
  I0.2g’s aggregate disposition is the remaining source-inventory disposition
  before the inventory can become a parity claim; I0.2c provenance/artifact
  integrity and I0.3 cardinality/domain mapping are source-closed, while I0.4
  still owns the aggregate zero-unmapped/duplicate and deterministic closure.
