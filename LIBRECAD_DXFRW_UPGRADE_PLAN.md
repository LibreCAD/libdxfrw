...
- Previous implementation slice: S95/J71 SHAPE entity parity is committed.
...
- Last fully resolved slice: S94 (the GEOPOSITIONMARKER entity parity slice is committed
...
- Previous fully resolved slice: S93 (the CAMERA entity parity slice is committed
...
- Resolved slices: 95 (`COMMITTED`).
- Slice states: 0 READY / 0 PLANNED / 0 ACTIVE / 0 VERIFYING / 0 VERIFIED /
  0 BLOCKED_HARD / 0 SUPERSEDED / 95 COMMITTED.
- Parent-item states: 0 READY / 0 PLANNED / 0 ACTIVE / 0 VERIFYING /
  0 VERIFIED / 0 BLOCKED_HARD / 0 SUPERSEDED / 95 COMMITTED.
...
- Active work: S01-S95 are committed; no slice is currently active. S95's
  ...
  import-scope, sync, and plan gates attached to its commit. The AC1015 SHAPE
  boundary is explicit; revisit it only with a safe low-handle route or an
  authoritative legacy sample.
