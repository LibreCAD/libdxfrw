...
249 commits ahead with no commits behind it. The latest green slice is
S223/J199, including the live-plan update and its required policy gates.
S224/J200 is the active slice; its DXF raw-section application-group marker
...
- Current checkpoint (2026-09-15): S223/J199 DXF raw-section application-group
  nesting depth parity is committed; S224/J200 DXF raw-section application-group
  ...
  sequence is S224 DXF raw-section application-group marker lexeme parity;
...
- Previous fully resolved slice: S100 (the NAVISWORKSMODEL entity parity slice is committed
  ...
  `6969e0a003414f9a7084349ac54bc2b32515e16b`; all in-horizon lanes are
  terminal only when their recorded gates pass.
- Resolved slices: 223 (`COMMITTED`); S224 is active.
- Slice states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING / 0 VERIFIED /
  0 BLOCKED_HARD / 0 SUPERSEDED / 223 COMMITTED.
- Parent-item states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING /
  0 VERIFIED / 0 BLOCKED_HARD / 0 SUPERSEDED / 225 COMMITTED.
- Expanded child-item states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING /
  0 BLOCKED_HARD / 0 SUPERSEDED / 3 VERIFIED / 321 COMMITTED; no child is
  anonymous.
- Claim/evidence dispositions (parents): 10 NOT_EVALUATED / 0 SATISFIED /
  0 DEFERRED_EXTERNAL / 208 EXPERIMENTAL / 0 PROMOTED / 6 NOT_APPLICABLE.
- Active work: S01-S223 are committed; S224/J200 is active with a ready packet
...
| S224 | J200: DXF raw-section application-group marker lexeme parity | S223 | ACTIVE | valid opening marker; valid closing marker; malformed marker rejection; ASCII/binary symmetry; transactional output; focused DXF gate; plan/scope/sync/fixture gates | use local sections with valid `{GROUP`/`}` markers and malformed `{`/`GROUP` lexemes; assert valid replay and malformed zero-output rejection in ASCII and binary, with no drawing bytes committed | active after S223 commit; use Wave 1 raw-section marker tests, focused CTest selector, fast source/policy gates, fixture admission, import scope, pinned sync, and diff gates |
...
| J200 | S224 | J199 | ACTIVE | EXPERIMENTAL | Qualify DXF raw-section application-group marker lexeme parity | active packet names valid 102 marker replay and malformed marker rejection in ASCII/binary; no-fixture evidence |
