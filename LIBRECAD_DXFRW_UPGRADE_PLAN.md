...
- Active work: S21/I3 DWG-reader and S22/I4 DWG-writer lanes are independent
  and ready after the committed S19 harness and S20 DXF source gate. Their
  fast lanes will validate route/container/dispatch and writer binding/
  preservation contracts first; ODA/spec, sample, sanitizer, and external
  oracle evidence remains checkpoint/nightly and cannot be fabricated.
