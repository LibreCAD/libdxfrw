...
- Active work: S01-S384 and J329/J329.1/J330/J330.1/J331/J331.1/J332/J332.1/
  ...
  J345/J345.1/J346/J346.1/J347/J347.1/J348/J348.1/J349/J349.1/J350/J350.1/J351/J351.1/J352/J352.1/J353/J353.1/J354/J354.1/J355/J355.1/J356/J356.1/J357/J357.1/J358/J358.1/J359/J359.1/J359.2/J360/J360.1/J360.2/J360.3/J361/J361.1/J362/J362.1/J362.2/J362.3/J363/J363.0/J363.1/J363.2 and S384a/S385/S386/S386a/S386b/S387a/S387/S389/S390/S391/S392/S393/S394/S395/S396/S397/S398 are committed.  S388/J364.1 is VERIFYING after the hosted runs exposed cross-platform compile defects; S399/J364.13 is ACTIVE for the AC1015 self-read diagnostic, and J364.2 remains planned until a complete focused receipt set is accepted.
...
| S399 | J364.13: diagnose Windows AC1015 self-read stage | S398 | ACTIVE | AC1015/format-15 self-read path; focused native build; qualification digest/status; plan; fixture; diff | add bounded `dwgRW::getLastDiagnostic()` output when the local round-trip reader rejects its just-published AC1015 file; hosted run `35183487882` reports 40 assertions and `DXF file error: format 15 error 11` only for version 13; no behavior, claim, or fixture bytes change; implementation digest `51db6eb4cd8cfa3e7d3ee68fbfe40e97226748171a07d2378818e929bdf53773` is staged | run the focused test, push the diagnostic slice, inspect the exact reader stage, then add a targeted repair slice without stopping if the hosted log exposes a deterministic defect |
...
| J364.13 | J364 / S399 | WP8, WP10; Windows AC1015 self-read diagnostic | J364.12 | ACTIVE | DEFERRED_EXTERNAL | print the public `dwgRW` self-read diagnostic only when the local round-trip test rejects an AC1015/format-15 output; keep diagnostics bounded and non-mutating, recompute digest/status, and preserve the no-claim/no-fixture policy | hosted run `35183487882` reports `DXF file error: format 15 error 11` and 40 AC1015 assertions after publication succeeds; run the diagnostic slice, push it, and use the exact stage to scope the next reader repair |
