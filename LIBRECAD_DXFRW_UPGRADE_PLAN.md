...
206 commits ahead with no commits behind it. The latest green slice is
S180/J156, including the live-plan update and its required policy gates.
S181/J157 is the active slice; its DXF raw-entity application-group depth-limit
...
- Current checkpoint (2026-09-15): S180/J156 DXF raw-entity application-group
  remap parity is committed; S181/J157 DXF raw-entity application-group
  depth-limit parity is active.
  The
  ...
  sequence is S181 DXF raw-entity application-group depth-limit parity;
...
- Previous fully resolved slice: S100 (the NAVISWORKSMODEL entity parity slice is committed
  ...
  `6969e0a003414f9a7084349ac54bc2b32515e16b`; all in-horizon lanes are
  terminal only when their recorded gates pass.
- Resolved slices: 180 (`COMMITTED`); S181 is active.
- Slice states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING / 0 VERIFIED /
  0 BLOCKED_HARD / 0 SUPERSEDED / 180 COMMITTED.
- Parent-item states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING /
  0 VERIFIED / 0 BLOCKED_HARD / 0 SUPERSEDED / 182 COMMITTED.
- Expanded child-item states: 0 READY / 0 PLANNED / 1 ACTIVE / 0 VERIFYING /
  0 BLOCKED_HARD / 0 SUPERSEDED / 3 VERIFIED / 278 COMMITTED; no child is
  anonymous.
- Claim/evidence dispositions (parents): 10 NOT_EVALUATED / 0 SATISFIED /
  0 DEFERRED_EXTERNAL / 165 EXPERIMENTAL / 0 PROMOTED / 6 NOT_APPLICABLE.
- Active work: S01-S180 are committed; S181/J157 is active with a ready packet
  naming DXF raw-entity application-group depth-limit parity and focused fast gates.
...
| S181 | J157: DXF raw-entity application-group depth-limit parity | S180 | ACTIVE | maximum nested 102 depth; ASCII/binary rejection symmetry; boundary acceptance; transactional output; focused DXF gate; plan/scope/sync/fixture gates | use local generated marker vectors at the supported depth and one beyond it; assert boundary acceptance and over-limit rejection with zero output in both encodings; no drawing bytes committed | active after S180 commit; use Wave 1 application-group depth tests, focused CTest selector, fast source/policy gates, fixture admission, import scope, pinned sync, and diff gates |
...
| J157 | S181 | J156 | ACTIVE | EXPERIMENTAL | Qualify DXF raw-entity application-group depth-limit parity | active packet names boundary-depth acceptance, over-limit rejection, ASCII/binary symmetry, transactional output, and no-fixture evidence |
